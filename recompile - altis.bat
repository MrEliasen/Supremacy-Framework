...
start C:\Arma_3_Server\arma3server -port=2302 "-config=C:\Arma_3_Server\TADST\altis\TADST_config.cfg" "-cfg=C:\Arma_3_Server\TADST\altis\TADST_basic.cfg" "-profiles=C:\Arma_3_Server\TADST\altis" -name=supremacy "-mod=heli;mark;@extDB3;@supremacy_server" -enableHT
@exit