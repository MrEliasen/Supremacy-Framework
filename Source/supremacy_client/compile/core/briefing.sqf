...
<br/>
Copyright (c) 2016 Mark ""Simply"" Eliasen - 3rd party scripts are copyrighted by their respective owners."
]
];
...
"Special Thanks",
"Shuko - SHK_pos<br/>
Bryan ""Tonic"" Boardwine - async extDB2<br/>
Karel Moricky - ""numberToText""<br/>
HallyG - progress bar<br/>
