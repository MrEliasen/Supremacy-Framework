...
private["_player","_item","_wpitem","_moneyIndex","_priceIndex","_money","_price","_pricelist","_isVehicle","_sellPercentage","_controller","_attachments","_confirm","_empty"];
...
if (!_isVehicle) then {
    ...
    // in case it was not deleted client side, delete it now.
    deleteVehicle _item;
    _confirm = true;
    _isVehicle = true;
